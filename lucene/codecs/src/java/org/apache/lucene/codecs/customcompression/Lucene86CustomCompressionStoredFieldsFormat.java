...
public class Lucene86CustomCompressionStoredFieldsFormat extends StoredFieldsFormat {
  // chunk size for zstandard
  private static final int ZSTD_BLOCK_LENGTH = 10 * 48 * 1024;

  public static final String MODE_KEY =
      Lucene86CustomCompressionStoredFieldsFormat.class.getSimpleName() + ".mode";

  final Lucene86CustomCompressionCodec.Mode mode;

  private int compressionLevel;

  /** default constructor */
  public Lucene86CustomCompressionStoredFieldsFormat() {
    this(
        Lucene86CustomCompressionCodec.Mode.ZSTD_DICT,
        Lucene86CustomCompressionCodec.defaultCompressionLevel);
  }

  /** Stored fields format with specified compression algo. */
  public Lucene86CustomCompressionStoredFieldsFormat(
      Lucene86CustomCompressionCodec.Mode mode, int compressionLevel) {
  ...
  public StoredFieldsReader fieldsReader(
    ...
    Lucene86CustomCompressionCodec.Mode mode = Lucene86CustomCompressionCodec.Mode.valueOf(value);
  ...
  StoredFieldsFormat impl(Lucene86CustomCompressionCodec.Mode mode) {
    switch (mode) {
      case ZSTD:
        return new Lucene86CompressingStoredFieldsFormat(
