...
public final class Lucene86CustomCompressionCodec extends FilterCodec {
  ...
  /** Default codec */
  public Lucene86CustomCompressionCodec() {
    this(Mode.ZSTD_DICT, defaultCompressionLevel);
  }

  /** new codec for a given compression algorithm and compression level */
  public Lucene86CustomCompressionCodec(Mode compressionMode, int compressionLevel) {
    super("Lucene90CustomCompression", new Lucene87Codec());
    ...
    switch (compressionMode) {
      case ZSTD:
        ...
        this.storedFieldsFormat =
            new Lucene86CustomCompressionStoredFieldsFormat(Mode.ZSTD, compressionLevel);
        break;
      ...
      case ZSTD_DICT:
        ...
        this.storedFieldsFormat =
            new Lucene86CustomCompressionStoredFieldsFormat(Mode.ZSTD_DICT, compressionLevel);
        break;
